...
/**
 * This is the model class for table "verbEN".
 *
 * @property integer $id
 ...
 */
class VerbEN extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return VerbENQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new VerbENQuery(get_called_class());
    }
    ...
    {
        return $this->hasMany(TagSR::className(), ['id' => 'tag_en_id'])
            ->viaTable('{{%verb_en_tag_en_assn}}', ['verb_id' => 'id']);
    }
