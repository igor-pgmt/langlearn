...
$this->params['breadcrumbs'][] = ['label' => $this->title, 'url' => ['/verb-en/view?id=' . $model->id]];
$this->params['breadcrumbs'][] = Yii::t('frontend', 'Update');
?>
<div class="verben-update">
...
function addRow(typeOfInsert) {
	...
	div1.className = 'field-verben-'+typeOfInsert+'-'+ i +'-native has-success';
	div2.className = 'field-verben-'+typeOfInsert+'-'+ i +'-translated has-success';
	...
	input1.id = 'verben-'+typeOfInsert+'-'+ i +'-native';
	input2.id = 'verben-'+typeOfInsert+'-'+ i +'-translated';
